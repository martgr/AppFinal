	...
	public void Registrar (View v){
        	...
        	String nombreBDD=txNombre.getText().toString();
      		...
      		if (db != null) {   
	            ...
	            try
	            {							//select nombre from Usuarios where nombre='xxxxx'
	                Cursor c = db.rawQuery("select nombre from Usuarios where nombre='"+nombreBDD+"'", null);
	                c.moveToFirst();
				...
				if (nombre ==null){
      				...
      				db.execSQL("INSERT INTO Usuarios (Nombre, record, bankias) "
      						+ "VALUES ('" + nombreBDD + "', " + record + ", " + bankias + ")");
	...
	public void OnClick (View v){
  	  ...
  	  String intro=txNombre.getText().toString();
		 ...
		 UsuariosSQLiteHelper usdbh =
	            ...
	            try
	            {							//select nombre from Usuarios where nombre='xxxxx'
	                Cursor c = db.rawQuery("select nombre from Usuarios where Nombre='"+intro+"'", null);
	                c.moveToFirst();
