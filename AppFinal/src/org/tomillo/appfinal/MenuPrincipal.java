...
public class MenuPrincipal extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//miJugador.setNumJugadas(mijJugador.getNumJugadas()+1);
		    	...
		    	final String usuario= getIntent().getExtras().getString("claveNombreJugador");
		...
		/*crear nuevo layout con puntuaciones
		final ImageButton records = (ImageButton)findViewById(id.ImgBtnRecords);
		records.setOnClickListener(new View.OnClickListener() {
			
			/@Override
			public void onClick(View v) {
			Intent puntuacion= new Intent(MenuPrincipal.this, km.class);
